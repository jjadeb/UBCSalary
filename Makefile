...
# Clean salary data
data/salary_data/all_clean_salary_data.csv : scripts/clean_salary_data.py data/salary_data/raw_salary_data.pickle
	python scripts/clean_salary_data.py \
	--raw_salary_data_file=data/salary_data/raw_salary_data.pickle \
	--clean_salary_data_output_folder=data/salary_data
...
scripts/corpus_gender_prediction.py data/salary_data/all_clean_salary_data.csv \
...
clean :
	-rm -r data/salary_data/yearly_salary_data
